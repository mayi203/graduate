...
public abstract class LibAsyncTask<Params, Progress, Result> {
	 ...
	 */
	public static final Executor SERIAL_EXECUTOR = DevUtil.hasHoneycomb() ? new SerialExecutor()
	 ...
	 *             {@link LibAsyncTask.Status#RUNNING} or
	 *             {@link LibAsyncTask.Status#FINISHED}.
	 * 
	 * @see #executeOnExecutor(java.util.concurrent.Executor, Object[])
	 * @see #execute(Runnable)
	 */
	public final LibAsyncTask<Params, Progress, Result> execute(
			Params... params) {
	 ...
	 * @see #execute(Object[])
	 */
	public final LibAsyncTask<Params, Progress, Result> executeOnExecutor(

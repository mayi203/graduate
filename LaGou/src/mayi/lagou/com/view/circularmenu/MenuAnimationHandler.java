...
public abstract class MenuAnimationHandler {
	...
	/**
	 * Restores the specified sub action view to its final state, accoding to
	...
	protected void restoreSubActionViewAfterAnimation(
		...
		FrameLayout.LayoutParams params = (FrameLayout.LayoutParams) subActionItem.view
				.getLayoutParams();
		...
		if (actionType == ActionType.OPENING) {
			...
			params.setMargins(center.x - subActionItem.width / 2, center.y
					- subActionItem.height / 2, 0, 0);
			subActionItem.view.setLayoutParams(params);
			((ViewGroup) menu.getActivityContentView())
					.removeView(subActionItem.view);
		}
	}

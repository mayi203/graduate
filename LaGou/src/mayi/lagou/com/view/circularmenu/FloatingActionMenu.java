...
public class FloatingActionMenu {
	 ...
	 * @param animated
	 */
	public FloatingActionMenu(View mainActionView, int startAngle,
			int endAngle, int radius, ArrayList<Item> subActionItems,
	...
	public void open(boolean animated) {
		...
		if (animated && animationHandler != null) {
			...
			for (int i = 0; i < subActionItems.size(); i++) {
				...
				//
				((ViewGroup) getActivityContentView()).addView(
						subActionItems.get(i).view, params);
			}
	...
	public void close(boolean animated) {
		...
		if (animated && animationHandler != null) {
			...
			for (int i = 0; i < subActionItems.size(); i++) {
				((ViewGroup) getActivityContentView())
						.removeView(subActionItems.get(i).view);
			}
		}
	...
	private Point getScreenSize() {
		...
		((Activity) mainActionView.getContext()).getWindowManager()
	...
	public static class Builder {
		...
		public Builder(Activity activity) {
			...
			// Default settings
			radius = activity.getResources().getDimensionPixelSize(

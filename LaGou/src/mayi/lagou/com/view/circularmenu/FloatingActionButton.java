...
public class FloatingActionButton extends FrameLayout {
	 ...
	 * 
	 * @param activity
	 *            a reference to the activity that will
	 * @param layoutParams
	 * @param theme
	 ...
	 * @param contentParams
	 */
	public FloatingActionButton(Activity activity, LayoutParams layoutParams,
			int theme, Drawable backgroundDrawable, int position,
	...
	public void setContentView(View contentView,
		...
		if (contentParams == null) {
			...
			final int margin = getResources().getDimensionPixelSize(
					R.dimen.action_button_content_margin);
	...
	public static class Builder {
		...
		public Builder setBackgroundDrawable(int drawableId) {
			return setBackgroundDrawable(activity.getResources().getDrawable(
					drawableId));
		}
		...
		public FloatingActionButton build() {
			return new FloatingActionButton(activity, layoutParams, theme,
					backgroundDrawable, position, contentView, contentParams);
		}
	}
